...
namespace gSLICr
{
	namespace engines
	{
		...
		protected:
			...
			virtual void Cvt_Img_Space_(UChar4Image* inimg, Float4Image* outimg, COLOR_SPACE color_space, float *a, float *b, float *L) =0 ;
		...
		public:
			...
			// Un poco cutreceur viniendo de Oxford no?
			virtual void Draw_Segmentation_Result(UChar4Image* out_img){};

			// EA 
			virtual void ComputePixelMap()abstract;

			// EA 
			virtual void ConvertToArrays(float *dev_a, float *dev_b, float * dev_L,int size) ;
